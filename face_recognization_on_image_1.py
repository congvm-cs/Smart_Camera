...
def main():
    ...
    facenet_model_dir = './model_check_point/20170512-110547.pb'
    mtcnn_model_dir = './model_check_point/'
    classification_model_dir = './model_check_point/classification_model.pkl'
...
if __name__ == '__main__':  
    ...
    parser.add_argument('--image_name', type=str, action='store', dest='image_name',
